...
const sbom = {
  ...
  documentNamespace: `https://github.com/elviass/dsh-usage-insights/sbom/${namespaceHash}`,
  creationInfo: { created: new Date().toISOString(), creators: ['Tool: dsh-usage-insights-build-release'] },
